        ...
        <div class="card card-body">
            <form action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" id="email" placeholder="Enter your e-mail" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" id="password" placeholder="Enter your password"
                           class="form-control" v-model="user.password" :class="[{'is-invalid': errorFor('password')}]"/>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm your password"
                           class="form-control" v-model="user.password_confirmation" :class="[{'is-invalid': errorFor('password_confirmation')}]"/>
